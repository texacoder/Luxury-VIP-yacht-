...
(function () {
  ...
  window.VIPYachtsPages.gallery = function () {
    ...
    var IMAGES = [
      ...
      { src: 'images/yacht-notorious-2023-exterior-1.jpg', category: 'fleet', alt: 'Notorious exterior view 1' },
      { src: 'images/yacht-notorious-2023-exterior-2.jpg', category: 'fleet', alt: 'Notorious exterior view 2' },
      { src: 'images/yacht-notorious-2023-exterior-3.jpg', category: 'fleet', alt: 'Notorious exterior view 3' },
      ...
      { src: 'images/yacht-notorious-2023-bathroom.jpg', category: 'interiors', alt: 'Notorious bathroom' },
      { src: 'images/yacht-notorious-2023-guest-cabin-1.jpg', category: 'interiors', alt: 'Notorious guest cabin 1' },
      { src: 'images/yacht-notorious-2023-guest-cabin-2.jpg', category: 'interiors', alt: 'Notorious guest cabin 2' },
      { src: 'images/yacht-notorious-2023-main-salon.jpg', category: 'interiors', alt: 'Notorious main salon' },
      { src: 'images/yacht-notorious-2023-master-cabin.jpg', category: 'interiors', alt: 'Notorious master cabin' },
      { src: 'images/yacht-notorious-2023-salon-lounge.jpg', category: 'interiors', alt: 'Notorious salon lounge' },
      ...
      { src: 'images/yacht-notorious-2023-aft-deck-dining.jpg', category: 'experiences', alt: 'Notorious aft deck dining' },
      { src: 'images/yacht-notorious-2023-aft-lounge.jpg', category: 'experiences', alt: 'Notorious aft lounge' },
      { src: 'images/yacht-notorious-2023-flybridge-seating.jpg', category: 'experiences', alt: 'Notorious flybridge seating' },
      { src: 'images/yacht-notorious-2023-sundeck.jpg', category: 'experiences', alt: 'Notorious sundeck' },
